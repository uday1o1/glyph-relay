...
| M0-L10 | `PENDING_LOCAL` | Local qualification phases, structured result schemas, documentation, and complete local verification | Content-addressed bundle, durable runner core, and disposable-remote tests are implemented; complete target phase coverage remains pending |
